...
if audio_bytes:
    ...
    transcript = openai.Audio.translate("whisper-1", wav_file, language="en", prompt="What would you like to do?")
    ...
    if stateRestrictor != "":
        ...
        data = data.loc[data['CBSA Name'].str.split(', ').str[1].str.contains(stateRestrictor)] 
